// Perplexity拡張機能 設定ページ用JavaScript
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function loadSettings() {
    chrome.storage.sync.get({
      ...
      retryCountSelect.value = settings.retryCount;
  ...
  function saveSettings() {
    const settings = {
      ...
      retryCount: parseInt(retryCountSelect.value),
    ...
    if (settings.timeout < 30 || settings.timeout > 300) {
